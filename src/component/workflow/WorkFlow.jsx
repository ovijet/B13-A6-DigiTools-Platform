  ...
  return (
    <div className="flex">
      <div className="flex flex-col justify-center items-center space-y-2  w-full p-10 bg-gradient-to-b from-[rgba(79,57,246,1)] to-[rgba(149,20,250,1)] mt-10">
        <h1 className=" text-2xl text-center md:text-3xl font-semibold text-white">Ready to Transform Your Workflow?</h1>
        <p className=" text-gray-400 md:text-gray-400 text-[15px] max-w-[500px] text-center">
        ...
        <div className=" md:flex gap-5 text-gray-300 mt-5 text-[15px]">
